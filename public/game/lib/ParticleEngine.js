...
ParticleEngine.prototype.initialize = function () {
  ...
  for (var i = 0; i < this.particleCount; i++) {
    ...
    points.push(this.particleArray[i].position);
    this.particleGeometry.attributes.customVisible.array[
      i
    ] = this.particleArray[i].alive;
    this.particleGeometry.attributes.customColor.array[i] = this.particleArray[
      i
    ].color;
    this.particleGeometry.attributes.customOpacity.array[
      i
    ] = this.particleArray[i].opacity;
    this.particleGeometry.attributes.customSize.array[i] = this.particleArray[
      i
    ].size;
    this.particleGeometry.attributes.customAngle.array[i] = this.particleArray[
      i
    ].angle;
  }
...
ParticleEngine.prototype.update = function (dt) {
  ...
  for (var i = 0; i < this.particleCount; i++) {
    if (this.particleArray[i].alive) {
      ...
      this.particleGeometry.attributes.customColor.array[
        i
      ...
      this.particleGeometry.attributes.customAngle.array[
        i
  ...
  for (var j = 0; j < recycleIndices.length; j++) {
    ...
    positions[i] = this.particleArray[i].position;
  }
